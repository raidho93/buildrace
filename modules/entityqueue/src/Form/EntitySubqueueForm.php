...
class EntitySubqueueForm extends ContentEntityForm {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    // Reverse in admin form is queue is set to 'Reverse order in admin view'
  ...
  public static function submitAction(array &$form, FormStateInterface $form_state) {
    ...
    if ($key_exists) {
      ...
      // Revert reverse in admin form is queue is set to 'Reverse order in admin view'
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    // Revert reverse in admin form in queue 
